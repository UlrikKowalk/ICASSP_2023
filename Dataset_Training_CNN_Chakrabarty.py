...
class Dataset_Training_CNN_Chakrabarty(Dataset):
    ...
    def __getitem__(self, index):
        ...
        feature = Feature_CNN_Chakrabarty(frame_length=self.frame_length,
        ...
        m_out_feature = torch.unsqueeze(feature.calculate(x_frame), dim=0)

        parameters = {'snr': snr_desired,
                      'rt_60': rt_60_desired,
                      'signal_type': signal_type}

        return m_out_feature, desired_label, parameters
