...
class Dataset_Testing_GADOAE_max_random(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for frame in range(num_frames):
            ...
            m_out_feature[frame, :] = feature.calculate_max(x[:, idx_in:idx_out])
        ...
        return m_out_feature, desired_label, coordinates, parameters, x # true coordinates known to srpphat and music
