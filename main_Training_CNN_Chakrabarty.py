...
from Dataset_Training_CNN_Chakrabarty import Dataset_Training_CNN_Chakrabarty
from Timer import Timer
from Training_CNN import Training_CNN
...
if __name__ == '__main__':
    ...
    if is_training:
        ...
        dataset = Dataset_Training_CNN_Chakrabarty(parameters=PARAMETERS, device=device)
        ...
        Trainer = Training_CNN(model=dnn, loss_fn=loss_fn, optimiser=optimiser, dataset=dataset,
