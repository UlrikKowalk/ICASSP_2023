...
from Dataset_Training_GADOAE_full import Dataset_Training_GADOAE_full
from Timer import Timer
from Training_DNN_GADOAE import Training_DNN_GADOAE

# This DNN takes as input the each GCC-PHAT permutation + mic coordinates -> Trained for any geometry
...
if __name__ == '__main__':
    ...
    if is_training:
        ...
        dataset = Dataset_Training_GADOAE_full(parameters=PARAMETERS, device=device)
