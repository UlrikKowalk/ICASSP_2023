...
from DNN_GADOAE5_max_reduce import DNN_GADOAE5_max_reduce
from Dataset_Training_GADOAE_max import Dataset_Training_GADOAE_max
from Timer import Timer
from Training_DNN_GADOAE import Training_DNN_GADOAE

# This DNN takes as input the argmax lag for each GCC-PHAT permutation + mic coordinates -> Trained for any geometry
...
if __name__ == '__main__':
    ...
    if is_training:
        ...
        dataset = Dataset_Training_GADOAE_max(parameters=PARAMETERS, device=device)

        # creating dnn and pushing it to CPU/GPU(s)
        dnn = DNN_GADOAE5_max_reduce(num_channels=PARAMETERS['num_channels'],
        ...
        Trainer = Training_DNN_GADOAE(model=dnn, loss_fn=loss_fn, optimiser=optimiser, dataset=dataset,
